...
--file-type TYPE          # File type to download: drz, flt, crj (default: drz)
...
- `drz`: Drizzled science images (default, science-ready)
- `flt`: Flat-fielded images (individual exposures)
- `crj`: Cosmic ray rejected images

```bash
python3 check_HST_coverage.py --tns "SN 2009ip" --download --file-type flt --max-images 3
```
